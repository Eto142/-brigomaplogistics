...
<head>
    ...
    <title>TRACKING • {{ $shipment->tracking_number }} • Global Logistics Network</title>
    ...
    <style>
        ...
        * {
        ...
        .timeline-progress {
            ...
            top: 0;
            width: 2px;
            background: linear-gradient(to bottom, #0051a2, #3b82f6);
            z-index: 2;
...
<body>
    ...
    <div class="status-text">
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                <div class="metric-value">{{ $shipment->quantity }} {{ $shipment->piece_type }}</div>
                <div class="metric-label">TOTAL QUANTITY</div>
            </div>
            <div class="metric-card">
                <div class="metric-value">{{ $shipment->weight }}</div>
                <div class="metric-label">TOTAL WEIGHT</div>
            </div>
            <div class="metric-card">
                <div class="metric-value">{{ $shipment->height }}</div>
                <div class="metric-label">DIMENSIONS (H)</div>
            </div>
            <div class="metric-card">
                <div class="metric-value">{{ $shipment->value }}</div>
    ...
    <div class="info-section">
        ...
        <div class="info-value strong">
            <span class="field-label">Name:</span> {{ $shipment->shipper_name }}
        </div>
        ...
        <div class="info-value">
            <span class="field-label">Postal Code:</span> {{ $shipment->shipper_postal_code }}
        </div>
        @endif
    </div>
    ...
    <div class="info-section">
        ...
        <div class="info-value strong">
            <span class="field-label">Name:</span> {{ $shipment->receiver_name }}
        </div>
        ...
        <div class="info-value">
            <span class="field-label">City / Country:</span> {{ $shipment->receiver_city }}, {{ $shipment->receiver_country }}
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-section">
                            <div class="info-label">Shipment Information</div>
                            <div class="info-value">Mode: {{ $shipment->shipment_mode }}</div>
                            <div class="info-value">Carrier: {{ $shipment->carrier }}</div>
                            <div class="info-value">Ref No: {{ $shipment->reference_no }}</div>
                        </div>
                        
                        <div class="info-section">
                            <div class="info-label">Logistics Data</div>
                            <div class="info-value">Total Freight: {{ $shipment->total_freight }}</div>
                            <div class="info-value">Payment Mode: {{ $shipment->payment_mode }}</div>
                            <div class="info-value">Value: {{ $shipment->value }}</div>
                        </div>
                    </div>
                </div>
...
<div class="current-status">
    ...
    <!-- Timing Information -->
    <div class="eta-display">
        <div class="eta-label">Departure</div>
        <div class="eta-value">{{ $shipment->departure_time }}</div>
    </div>
    <div class="eta-display">
        <div class="eta-label">Expected Delivery</div>
        <div class="eta-value">{{ $shipment->expected_delivery_date }}</div>
    </div>
    <div class="eta-display">
        <div class="eta-label">Pickup Timing</div>
        <div class="eta-value">{{ $shipment->pickup_date }} at {{ $shipment->pickup_time }}</div>
    </div>
</div>
        ...
        <div class="system-footer">
            ...
            <div class="mt-2" style="font-size: 0.75rem; color: #94a3b8;">
                REF: {{ $shipment->tracking_number }} • LAST UPDATE: {{ now()->format('d M Y H:i:s') }} UTC
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setInterval(() => {
                ...
                const now = new Date();
                timestamp.textContent = `REF: {{ $shipment->tracking_number }} • LAST UPDATE: ${now.toUTCString().replace('GMT', 'UTC')}`;
